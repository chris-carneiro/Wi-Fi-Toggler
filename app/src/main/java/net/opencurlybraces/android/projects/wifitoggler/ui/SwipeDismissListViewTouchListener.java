 ...
 * clicks, etc. <p/> <p>After creating the listener, the caller should also call {@link
 ...
 * SwipeDismissListViewTouchListener} is paused during list view scrolling.</p> <p/> <p>Example
 * usage:</p> <p/>
 * <pre>
